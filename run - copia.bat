...
:startJava	
	start "Jupiter JRS from %~dp0" "%javaDir%"\bin\java.exe -Xmx640m -agentlib:jdwp=transport=dt_socket,address=8998,server=y,suspend=y -cp classes;lib\*;conf;addons\classes;addons\lib\* -Dnxt.runtime.mode=desktop nxt.Jup
