...
public final class APIJupProxyServlet extends AsyncMiddleManServlet {

    private static final String REMOTE_URL = APIJupProxyServlet.class.getName() + ".remoteUrl";
    private static final String REMOTE_SERVER_IDLE_TIMEOUT = APIJupProxyServlet.class.getName() + ".remoteServerIdleTimeout";
