...
import static jup.http.JSONResponses.FEATURE_NOT_AVAILABLE;
import static jup.http.JSONResponses.INCORRECT_DEADLINE;
import static jup.http.JSONResponses.INCORRECT_EC_BLOCK;
import static jup.http.JSONResponses.INCORRECT_LINKED_FULL_HASH;
import static jup.http.JSONResponses.INCORRECT_WHITELIST;
import static jup.http.JSONResponses.MISSING_DEADLINE;
import static jup.http.JSONResponses.MISSING_SECRET_PHRASE;
import static jup.http.JSONResponses.NOT_ENOUGH_FUNDS;
