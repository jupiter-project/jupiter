 ...
 * Constraints
 * <p>
 * This API is allowed only when the currency is {@link jup.CurrencyType#RESERVABLE} and is not yet active.
 * <p>
 ...
 * The list of founders and their NQT investment can be obtained using the {@link jup.http.GetCurrencyFounders} API.
 */
