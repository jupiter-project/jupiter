 ...
 * For {@link jup.CurrencyType#RESERVABLE} currency
 ...
 * For {@link jup.CurrencyType#MINTABLE} currency
 * <li>maxDifficulty - for mint-able currency, the exponent of the final difficulty.
 * For {@link jup.CurrencyType#MINTABLE} currency
 * <li>algorithm - the hashing {@link jup.crypto.HashFunction algorithm} used for minting.
 * For {@link jup.CurrencyType#MINTABLE} currency
 * </ul>
 * <p>
 * Constraints
 * <ul>
 * <li>A given currency can not be neither {@link jup.CurrencyType#EXCHANGEABLE} nor {@link jup.CurrencyType#CLAIMABLE}.<br>
 * <li>A {@link jup.CurrencyType#RESERVABLE} currency becomes active once the blockchain height reaches the currency issuance height.<br>
 ...
 * When a {@link jup.CurrencyType#RESERVABLE} becomes active, in case it is {@link jup.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link jup.CurrencyType#RESERVABLE} becomes active, in case it is non {@link jup.CurrencyType#CLAIMABLE} the NXT used for
 * reserving the currency are sent to the issuer account as crowd funding.
 * <li>When issuing a {@link jup.CurrencyType#MINTABLE} currency, the number of units per {@link jup.http.CurrencyMint} cannot exceed 0.01% of the
 ...
 * difficulty increases linearly with the number units minted per {@link jup.http.CurrencyMint}<br>
 * </ul>
 *
 * @see jup.CurrencyType
 * @see jup.crypto.HashFunction
 */
