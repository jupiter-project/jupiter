...
import jup.Currency;
import jup.CurrencyExchangeOffer;
import jup.CurrencyFounder;
...
public final class JSONData {
    ...
    static JSONObject lessor(Account account, boolean includeEffectiveBalance) {
        ...
        if (accountLease.getCurrentLesseeId() != 0) {
            ...
            if (includeEffectiveBalance) {
                json.put("effectiveBalanceNXT", String.valueOf(account.getGuaranteedBalanceNQT() / Constants.ONE_JUP));
            }
        }
