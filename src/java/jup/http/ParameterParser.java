...
import static jup.http.JSONResponses.INCORRECT_ACCOUNT;
import static jup.http.JSONResponses.INCORRECT_ALIAS;
import static jup.http.JSONResponses.INCORRECT_ARBITRARY_MESSAGE;
import static jup.http.JSONResponses.INCORRECT_DATA;
...
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_CHANNEL;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_DESCRIPTION;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_FILE;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_FILENAME;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_NAME;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_TAGS;
import static jup.http.JSONResponses.INCORRECT_TAGGED_DATA_TYPE;
import static jup.http.JSONResponses.MISSING_ACCOUNT;
import static jup.http.JSONResponses.MISSING_ALIAS_OR_ALIAS_NAME;
import static jup.http.JSONResponses.MISSING_NAME;
import static jup.http.JSONResponses.MISSING_PROPERTY;
import static jup.http.JSONResponses.MISSING_RECIPIENT_PUBLIC_KEY;
import static jup.http.JSONResponses.MISSING_SECRET_PHRASE;
import static jup.http.JSONResponses.MISSING_TRANSACTION_BYTES_OR_JSON;
import static jup.http.JSONResponses.UNKNOWN_ACCOUNT;
import static jup.http.JSONResponses.UNKNOWN_ALIAS;
import static jup.http.JSONResponses.UNKNOWN_ASSET;
import static jup.http.JSONResponses.UNKNOWN_CURRENCY;
import static jup.http.JSONResponses.UNKNOWN_GOODS;
import static jup.http.JSONResponses.UNKNOWN_OFFER;
import static jup.http.JSONResponses.UNKNOWN_POLL;
import static jup.http.JSONResponses.UNKNOWN_SHUFFLING;
import static jup.http.JSONResponses.either;
import static jup.http.JSONResponses.incorrect;
import static jup.http.JSONResponses.missing;
