...
public final class Constants {
    ...
    public static final int BLOCK_HEIGHT_HARD_FORK_INCREASE_MAX_BASE_TARGET = isTestnet ? Nxt.getIntProperty("nxt.hardBlockBaseTarget", 0) : 1750000;
    ...
    public static final long ORIGINAL_MAX_BASE_TARGET = INITIAL_BASE_TARGET * BASE_TARGET_MULTIPLIER;
    ...
    public static final int[] MIN_VERSION = new int[] {2, 1, 2};
    public static final int[] MIN_PROXY_VERSION = new int[] {2, 1, 2};
